 ...
 * @property Doctrine_Collection $Music
 * 
 ...
 * @method Doctrine_Collection getMusic()                 Returns the current record's "Music" collection
 ...
 * @method sfGuardUser         setMovies()                Sets the current record's "Movies" collection
 * @method sfGuardUser         setMusic()                 Sets the current record's "Music" collection
 * 
 * @package    mediaRepo
 * @subpackage model
...
abstract class BasesfGuardUser extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('mrBook as Books', array(
             'local' => 'id',
             'foreign' => 'user_id'));

        $this->hasMany('mrGame as Games', array(
             'local' => 'id',
             'foreign' => 'user_id'));

        $this->hasMany('mrMovie as Movies', array(
             'local' => 'id',
             'foreign' => 'user_id'));

        $this->hasMany('mrMusic as Music', array(
             'local' => 'id',
             'foreign' => 'user_id'));
